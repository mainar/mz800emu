...
/* chaky: ei callback patch */
LIB_EXPORT void z80ex_set_ei_callback(Z80EX_CONTEXT *cpu, z80ex_ei_cb cb_fn, void *user_data)
{
	cpu->ei_cb=cb_fn;
	cpu->ei_cb_user_data=user_data;
}
