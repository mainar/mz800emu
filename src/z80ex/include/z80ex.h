...
typedef void (*z80ex_ei_cb)(Z80EX_CONTEXT *cpu, void *user_data);
...
/* chaky: set EI callback*/
extern void z80ex_set_ei_callback(Z80EX_CONTEXT *cpu, z80ex_ei_cb cb_fn, void *user_data);
